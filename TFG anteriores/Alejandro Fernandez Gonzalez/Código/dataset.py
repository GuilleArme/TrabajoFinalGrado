...
class ShanghaiTechDataset(Dataset):
    ...
    def __init__(self, cfg, subdir, shuffle_seed=None, rel_inds=(0.0, 1.0), transform=None):
        ...
        Args:
            cfg: the global configuration.
            subdir: The subdirectory of the dir where the groundtruth data is stored.
        ...
        #Carga de los mapas de densidad
        npz_pattern = cfg.dataset.densmaps_gt_npz
        ...
        print(f"  '{os.path.relpath(npz_file)}' is taken as the "
